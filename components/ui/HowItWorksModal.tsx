...
export function HowItWorksModal() {
  ...
  const steps = [
    { number: "①", title: t("step1Title"), desc: t("step1Desc"), detail: t("step1Detail") },
    { number: "②", title: t("step2Title"), desc: t("step2Desc"), detail: t("step2Detail") },
    { number: "③", title: t("step3Title"), desc: t("step3Desc"), detail: t("step3Detail") },
    { number: "④", title: t("step4Title"), desc: t("step4Desc"), detail: t("step4Detail") },
  ]
      ...
      >
        ...
        <div style={{ padding: "20px 24px 24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
            ...
            <span style={{ fontFamily: "monospace", fontSize: 10, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.1em" }}>{t("label")}</span>
          </div>
